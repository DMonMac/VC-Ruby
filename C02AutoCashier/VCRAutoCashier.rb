...
#-------------------- RESETS THE COUNT OF ITEMS AND THE MONEY INPUT --------------------#
def reset
  @total = 0
  @items =
  [
...
#---------------------------------------- ENDS USER 'SESSION' AND RETURNS TO THE FIRST SCREEN ----------------------------------------#
...
#---------------------------------------- DISPLAYS CURRENT ITEMS ADDED AND TOTAL PRICE SO FAR ----------------------------------------#
def breakdown
  @total = 0
  puts '-'*92+"\n"*2+"Fruits [so far]:"+"\n"*2
  list
...
#---------------------------------------- DISPLAYS ITEMS AVAILABLE FOR PUSCHASE ----------------------------------------#
def itemShow
  head
  puts '-'*92+"\n"*2
  @items.each do |show|
...
#---------------------------------------- ASKS USER WHAT ITEM TO PURCHASE ----------------------------------------#
def purchase
  @total = 0
  itemShow
...
#---------------------------------------- SHOWS FINAL LIST OF ITEMS AND ASKS THE AMOUNT FOR PAYMENT ----------------------------------------#
def payment
  head
  @total=0
...
#---------------------------------------- COMPUTES CHANGE OR GIVES ADDITIONAL ACTIONS IF MONEY IS LACKING ----------------------------------------#
def lack?
  head
  breakdown
...
#---------------------------------------- ASKS FOR ADDITIONAL REDUCTIONS ----------------------------------------#
def redmore
  head
  breakdown
